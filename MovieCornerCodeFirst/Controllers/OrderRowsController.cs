...
namespace MovieCornerCodeFirst.Controllers
{
    public class OrderRowsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,MovieId,OrderId,Price")] OrderRow orderRow)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,MovieId,OrderId,Price")] OrderRow orderRow)
        {
            if (ModelState.IsValid)
            {
